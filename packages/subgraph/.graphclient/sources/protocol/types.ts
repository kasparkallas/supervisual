...
export namespace ProtocolTypes {
  ...
  export type PoolMember_filter = {
    ...
    poolTotalAmountDistributedUntilUpdatedAt_not?: InputMaybe<
      Scalars["BigInt"]
    >;
    ...
    poolTotalAmountDistributedUntilUpdatedAt_gte?: InputMaybe<
      Scalars["BigInt"]
    >;
    poolTotalAmountDistributedUntilUpdatedAt_lte?: InputMaybe<
      Scalars["BigInt"]
    >;
